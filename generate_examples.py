...
df.plot_animated(filename='examples/example-barh-chart.gif',hide_period=False)

df.plot_animated(filename='examples/example-barv-chart.gif',hide_period=False,orientation='v')
